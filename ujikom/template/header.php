...
<nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
  <a class="navbar-brand" href="index.php"><i class="fa fa-shopping-cart mr-1"></i><b>
  <?php 
...
<a class="navbar-brand text-white" href="index.php"><i class="fa fa-shopping-cart mr-1"></i><b>
  <?php 
      $toko = mysqli_query($conn,"SELECT * FROM login ORDER BY nama_toko ASC");
      while($dat = mysqli_fetch_array($toko)){
        $nama_toko = $dat['nama_toko'];
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pengaturan.php"><i class="fa fa-cog text-purple mr-2"></i>Pengaturan Admin</a>
                    </li>
                    <li class="nav-item">
